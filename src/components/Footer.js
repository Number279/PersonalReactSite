        ...
        <div className="row px-4">
          <div className="col-lg-7 mx-auto">
            ...
            <ul className="list-inline mb-0">
              <li className="list-inline-item"><a className="social-link" href="https://www.facebook.com/sawyer.carroll.7"><FaFacebookF /></a></li>
              <li className="list-inline-item"><a className="social-link" href="https://twitter.com/SawyerCarroll3"><FaTwitter /></a></li>
              <li className="list-inline-item"><a className="social-link" href="https://www.linkedin.com/in/sawyer-carroll-240634206/"><FaLinkedinIn /></a></li>
            </ul>
          </div>
        </div>
      </div>
